...
var deck_hardware = [
	...
	['Autonomy 12', 'How does the robot communicate that it will do so, and with what amount of notice?', '', true],
...
var deck_software = [
	['Safety-Psychological 1', 'Could use of the robot positively alter the user or their human network’s behaviour?', '', false],
	['Safety-Psychological 2', 'Could use of the robot negatively alter the user or their human network’s behaviour?', '', false],
	...
	['Privacy 1', 'Can individuals be identified in combination with other datasets?', '', false],
	['Privacy 2', 'Could the purpose of the robot be accomplished using synthetic data?', '', false],
	['Privacy 3', 'Are the user or their human network explicitly asked for consent on data gathered?', '', false],
	['Privacy 4', 'Can individuals, either inside or outside of the human network, block their data from being recorded? E.g., visitors to a home', '', false],
	...
	['Privacy 7', 'Can individuals have their data removed to a meaningful extent?', '', false],
	['Privacy 8', 'Is as minimal data collected as possible? E.g., does the robot need facial/vocal recognition to 	accomplish its stated purpose?', '', false],
	['Privacy 9', 'Is the data that is collected as minimally invasive as possible, or unless specifically requested by 	a member of the human network? E.g., ‘Profile 1 does not drink pop,’ not ‘Person 1 is diabetic’', '', false],
	['Privacy 10', 'Can collection be stopped by the user while the robot is active and/or inactive? See, e.g., guests in 	a home', '', false],
	['Privacy 11', 'Can the robot infer/collect/produce protected characteristics, either by proxy or directly?', '', 	false],
	['Privacy 12', 'Does the data collected need to be stored to accomplish the stated purpose of the robot?', '', false],
	['Privacy 13', 'To what extent do the robot’s actions change based on information collected post-deployment?', '', true],
	['Privacy 14', 'Can the data collected be area-blocked? E.g., signals on bathroom or sensitive areas that signal the 	robot to stop recording', '', false],
	['Privacy 15', 'Why does this data need to be recorded, and are there less intrusive ways to achieve the same 	purpose?', '', true],
	['Privacy 16', 'How might law enforcement or government use this data?', '', true],
	['Privacy 17', 'What precautions are taken for those who do not wish to interact with the robot? E.g., signs warning 	about recording? Or turn recording off?', '', true],
	...
	['Autonomy 1', 'To what extent and in what circumstances can users vary the robot’s autonomy?', '', true],
	['Autonomy 2', 'To what extent will the user have direct control over the robot’s actions?', '', true],
	['Autonomy 3', 'To what extent will the robot be controlled by members of the user’s human network?', '', true],
	['Autonomy 4', 'Does the robot ‘learn’ throughout its lifecycle?', '', false],
	['Autonomy 5', 'What measures have been taken to ensure robot does not \'learn\' negative elements from the human network (e.g., Microsoft’s Tay \'learning\' abusive language)', '', true],
	['Autonomy 6', 'What measures have been taken to ensure robot does not \'learn\' negative elements from the physical environment (e.g., \'learns\' to brake at crosswalk by \'watching\' other cars)', '', true],
	['Autonomy 7', 'To what extent and when can and will the robot hand over control to a human?', '', true],
	['Autonomy 8', 'What authority does the human require to do so?', '', true],
	['Autonomy 9', 'How does the robot communicate that it will hand over control to a human, and with what amount of notice?', '', true],
	['Autonomy 10', 'Does the robot accurately flag where it does not have the information to make an informed decision/action?', '', true],
	['Autonomy 11', 'Does the robot consistently provide its level of accuracy and confidence to the user?', '', true],
	['Autonomy 12', 'What information is provided to the user to overcome confirmation bias or learned carelessness (where the user trusts the robot’s input too greatly)?', '', true],
	['Autonomy 13', 'Can the robot inform a human when it is not functioning properly?', '', true],
	['Autonomy 14', 'Can the robot’s decision-making be overridden, and is it clear how to do so in the length of time appropriate for its use? (E.g., driving vs restocking a grocery store)', '', true],
	['Autonomy 15', 'What parameters are in place to prevent over-specification?', '', true],
	['Autonomy 16', 'What parameters are in place to prevent learning inappropriate behaviours, such as natural language input?', '', true],
	['Autonomy 17', 'Is there an ongoing series of testing to ensure self-learning is proceeding within acceptable parameters?', '', false],
	...
	['Explanations 8', 'Are these explanations in as clear a form as possible (with a greater need assigned to robots engaging in a safety-critical activity) to relevant stakeholders?	', '', true],  #Please specify: to designers? (sufficiently to update design); to the robot users’ human network?; to regulators?; to investigators of why an accident occurred?
...
var deck_legal = [
	...
	['Privacy 5', 'Can individuals be identified from this dataset?', '', false],
	['Privacy 6', 'Who has responsibility when new data is collected?', '', true],
	['Privacy 7', 'Who is the identified data controller?', '', true],
